...
local theme = lush (function (injected_functions)
    ...
    return {
        ...
        MatchParen ({ bg = dull }), -- Character under the cursor or just before it, if it is a paired bracket, and its match. |pi_paren.txt|
        ...
        Visual ({ bg = Normal.fg.li (75), fg = Normal.fg }), -- Visual mode selection
        ...
        String ({ fg = dim_gray }), --   A string constant: "this is a string"
